...
| -------- | ------------------- | --------------------------- | ------------------------------------------------------------------- |
| Sprint 0 | Woche 1–2           | Setup & Planning            | Jira-Projekt eingerichtet, Erweiterung gewählt, GitHub Repo geklont |
| Sprint 1 | Woche 3–5           | Requirements & Design       | Use-Case-Diagramm, Aktivitätsdiagramm, ERD, Sequenzdiagramm         |
| Sprint 2 | Woche 6–9           | Implementierung Kern        | Basisfunktionen lauffähig, Erweiterung begonnen                     |
| Sprint 3 | Woche 10–13         | Erweiterung & Finalisierung | Erweiterung fertig, Testing, Dokumentation, Deployment              |
